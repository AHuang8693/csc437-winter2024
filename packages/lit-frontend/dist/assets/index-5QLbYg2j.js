...
`}};Me.styles=[E(R),b`
    * {
      margin: 0;
      box-sizing: border-box;
    }`];Me=Qr([g("home-page")],Me);var Yr=Object.defineProperty,Xr=Object.getOwnPropertyDescriptor,Pe=(r,e,t,n)=>{for(var s=n>1?void 0:n?Xr(e,t):e,i=r.length-1,o;i>=0;i--)(o=r[i])&&(s=(n?o(e,t,s):o(s))||s);return n&&s&&Yr(e,t,s),s};let D=class extends v{constructor(){super(...arguments),this.path=""}render(){const{userid:r,name:e}=this.profile||{};return m`
      <p>Username: ${e}<br>ID: ${r} </p>
    `}};D.styles=[E(R),b`
  * {
    margin: 0;
    box-sizing: border-box;
  }`];Pe([_()],D.prototype,"path",2);Pe([Pt()],D.prototype,"profile",2);D=Pe([g("user-profile")],D);let Te=class extends D{render(){return m`<form @submit=${this._handleSubmit}>
        <label>Enter New Username:
          <input type="text" name="name"></label><br>
        <button type="submit">Submit</button>
    </form> `}_handleSubmit(r){r.preventDefault()}};Te.styles=[...D.styles,b`...`];Te=Pe([g("user-profile-edit")],Te);var Zr=Object.defineProperty,en=Object.getOwnPropertyDescriptor,jt=(r,e,t,n)=>{for(var s=n>1?void 0:n?en(e,t):e,i=r.length-1,o;i>=0;i--)(o=r[i])&&(s=(n?o(e,t,s):o(s))||s);return n&&s&&Zr(e,t,s),s};let fe=class extends q{get weapons(){return this.getFromModel("weapons")}firstUpdated(r){this.dispatchMessage({type:"WeaponsRequested"})}render(){return m`
      <main> 
        <h1>Weapons</h1>
