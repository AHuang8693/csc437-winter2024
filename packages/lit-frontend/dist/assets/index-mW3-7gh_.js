 ...
 */function Dr({context:r,subscribe:e}){return(t,n)=>{typeof n=="object"?n.addInitializer(function(){new Ze(this,{context:r,callback:s=>{this[n.name]=s},subscribe:e})}):t.constructor.addInitializer(s=>{new Ze(s,{context:r,callback:i=>{s[n]=i},subscribe:e})})}}var Lr=Object.defineProperty,Nr=Object.getOwnPropertyDescriptor,Ot=(r,e,t,n)=>{for(var s=n>1?void 0:n?Nr(e,t):e,i=r.length-1,o;i>=0;i--)(o=r[i])&&(s=(n?o(e,t,s):o(s))||s);return n&&s&&Lr(e,t,s),s};const Ct="WikiModel",Hr={user:new Z,weapons:[],systems:[],factions:[],roles:[]};class Ie extends Or{constructor(e){super(e,()=>this.model,t=>this.model=t),this.model=Hr}}Ot([jr({context:Ct}),At()],Ie.prototype,"model",2);class q extends Cr{getFromModel(e){if(this._model)return this._model[e]}}Ot([Dr({context:Ct,subscribe:!0}),_({attribute:!1})],q.prototype,"_model",2);const Ir=()=>new Rr,N=xr,H=Mr,R='body{font-family:var(--font-family-body);color:var(--color-text);background-color:var(--color-background);margin:1em}a,a:visited{color:var(--color-text)}h1,h3{font-family:var(--font-family-display);background-color:var(--color-brand);color:#fff;width:max-content;padding:0 .15em;margin-top:.67em;margin-bottom:.67em}section :not(h1,h3,strong,svg){margin-left:1.5em}em{display:inline-block}svg.icon{display:inline;height:var(--size-icon-normal);width:var(--size-icon-normal);vertical-align:bottom;fill:currentColor}section.trait>h3{background-color:red;color:#fff;width:max-content;padding:.1em .25em}section.system>h3{background-color:#27c52c;color:#fff;width:max-content;padding:.1em .25em}section.weapon>h3{grid-area:header;background-color:#000;color:#fff;width:max-content;padding:.1em .25em}.weapon{display:grid;grid-template-columns:auto 1fr;grid-template-rows:1fr 1fr 1fr;grid-template-areas:"header type" "tags ." "range dmg"}section.weapon>.type{align-self:center;grid-area:type}section.weapon>.tags{grid-area:tags}section.weapon>.range{grid-area:range}section.weapon>.dmg{grid-area:dmg}.wContainer.compact>.weapon{display:grid;grid-template-columns:auto 1fr 1fr 1fr 1fr;grid-template-rows:1fr;grid-template-areas:"header type tags range dmg"}.weapon h3{display:inline;grid-column:1/2}.stats{display:grid;grid-template-columns:1fr 1fr;width:max-content;column-gap:2em}.container{display:flex;flex-direction:row;justify-content:space-between;align-items:baseline}.container>div{width:125px}',x=Ir(),Rt=x.update;x.addMessage("ProfileSelected",r=>{const{userid:e}=r;return new k().get(`/profiles/${e}`).then(t=>{if(t.status===200)return t.json()}).then(t=>{if(t)return console.log("Profile:",t),t}).then(t=>t?N({profile:t}):H)});x.addMessage("ProfileSaved",r=>{const{userid:e,profile:t}=r;return new Pt(t).put(`/profiles/${e}`).then(n=>{if(n.status===200)return n.json()}).then(n=>{n&&console.log("Profile:",n)}).then(n=>n?N({profile:n}):H)});x.addMessage("WeaponsRequested",r=>new k().get("/weapons/").then(e=>{if(e.status===200)return e.json()}).then(e=>{if(e)return console.log("Weapons:",e),e}).then(e=>e?N({weapons:e}):H));x.addMessage("SystemsRequested",r=>new k().get("/systems/").then(e=>{if(e.status===200)return e.json()}).then(e=>{if(e)return console.log("Systems:",e),e}).then(e=>e?N({systems:e}):H));x.addMessage("PilotRequested",r=>new k().get("/pilot/").then(e=>{if(e.status===200)return e.json()}).then(e=>{if(e)return console.log("Pilot:",e),e}).then(e=>e?N({pilot:e}):H));x.addMessage("FactionsRequested",r=>new k().get("/factions/").then(e=>{if(e.status===200)return e.json()}).then(e=>{if(e)return console.log("Factions:",e),e}).then(e=>e?N({factions:e}):H));x.addMessage("RolesRequested",r=>new k().get("/roles/").then(e=>{if(e.status===200)return e.json()}).then(e=>{if(e)return console.log("Roles:",e),e}).then(e=>e?N({roles:e}):H));var Fr=Object.defineProperty,zr=Object.getOwnPropertyDescriptor,xt=(r,e,t,n)=>{for(var s=n>1?void 0:n?zr(e,t):e,i=r.length-1,o;i>=0;i--)(o=r[i])&&(s=(n?o(e,t,s):o(s))||s);return n&&s&&Fr(e,t,s),s};let he=class extends v{constructor(){super(...arguments),this.open=!1}render(){return m`
  ...
  `;xt([_({reflect:!0,type:Boolean})],he.prototype,"open",2);he=xt([g("drop-down")],he);var Br=Object.defineProperty,kr=Object.getOwnPropertyDescriptor,Mt=(r,e,t,n)=>{for(var s=n>1?void 0:n?kr(e,t):e,i=r.length-1,o;i>=0;i--)(o=r[i])&&(s=(n?o(e,t,s):o(s))||s);return n&&s&&Br(e,t,s),s};let de=class extends v{constructor(){super(...arguments),this.on=!1}render(){return m`<label>
      <slot>Label</slot>
      <span class="slider">
  ...
  `;Mt([_({reflect:!0,type:Boolean})],de.prototype,"on",2);de=Mt([g("toggle-switch")],de);var qr=Object.defineProperty,Vr=Object.getOwnPropertyDescriptor,Tt=(r,e,t,n)=>{for(var s=n>1?void 0:n?Vr(e,t):e,i=r.length-1,o;i>=0;i--)(o=r[i])&&(s=(n?o(e,t,s):o(s))||s);return n&&s&&qr(e,t,s),s};let ue=class extends v{constructor(){super(...arguments),this.avatar=""}render(){return m`
    <ul>
    <li class="header">
      <img src=${this.avatar} />
...
`;Tt([_()],ue.prototype,"avatar",2);ue=Tt([g("user-panel")],ue);var Wr=Object.defineProperty,Gr=Object.getOwnPropertyDescriptor,Ut=(r,e,t,n)=>{for(var s=n>1?void 0:n?Gr(e,t):e,i=r.length-1,o;i>=0;i--)(o=r[i])&&(s=(n?o(e,t,s):o(s))||s);return n&&s&&Wr(e,t,s),s};let pe=class extends v{constructor(){super(...arguments),this.on=!1}render(){return m`
        <div class="container">
        ...
        * {
          margin: 0;
          box-sizing: border-box;
        }`];Ut([_({attribute:!1})],pe.prototype,"on",2);pe=Ut([g("page-header")],pe);var Kr=Object.defineProperty,Jr=Object.getOwnPropertyDescriptor,Qr=(r,e,t,n)=>{for(var s=n>1?void 0:n?Jr(e,t):e,i=r.length-1,o;i>=0;i--)(o=r[i])&&(s=(n?o(e,t,s):o(s))||s);return n&&s&&Kr(e,t,s),s};let Me=class extends Ie{constructor(){super(Rt)}render(){return m`
<body>
    <h1>Lancer</h1>
...
`}};Me.styles=[E(R),b`
    * {
      margin: 0;
      box-sizing: border-box;
    }`];Me=Qr([g("home-page")],Me);var Yr=Object.defineProperty,Xr=Object.getOwnPropertyDescriptor,Ae=(r,e,t,n)=>{for(var s=n>1?void 0:n?Xr(e,t):e,i=r.length-1,o;i>=0;i--)(o=r[i])&&(s=(n?o(e,t,s):o(s))||s);return n&&s&&Yr(e,t,s),s};let D=class extends v{constructor(){super(...arguments),this.path=""}render(){const{userid:r,name:e}=this.profile||{};return m`
      <p>Username: ${e}<br>ID: ${r} </p>
    `}};D.styles=[E(R),b`
  * {
    margin: 0;
    box-sizing: border-box;
  }`];Ae([_()],D.prototype,"path",2);Ae([At()],D.prototype,"profile",2);D=Ae([g("user-profile")],D);let Te=class extends D{render(){return m`<form @submit=${this._handleSubmit}>
        <label>Enter New Username:
          <input type="text" name="name"></label><br>
        <button type="submit">Submit</button>
    </form> `}_handleSubmit(r){r.preventDefault()}};Te.styles=[...D.styles,b`...`];Te=Ae([g("user-profile-edit")],Te);var Zr=Object.defineProperty,en=Object.getOwnPropertyDescriptor,jt=(r,e,t,n)=>{for(var s=n>1?void 0:n?en(e,t):e,i=r.length-1,o;i>=0;i--)(o=r[i])&&(s=(n?o(e,t,s):o(s))||s);return n&&s&&Zr(e,t,s),s};let fe=class extends q{get weapons(){return console.log([this.getFromModel("weapons")]),this.getFromModel("weapons")}firstUpdated(r){this.dispatchMessage({type:"WeaponsRequested"})}render(){return m`
      <main> 
        <h1>Weapons</h1>
      ...
      </main>`}};fe.styles=[E(R),b`
        * {
          margin: 0;
          box-sizing: border-box;
        }`];jt([_()],fe.prototype,"weapons",1);fe=jt([g("weapons-page")],fe);var tn=Object.defineProperty,rn=Object.getOwnPropertyDescriptor,Dt=(r,e,t,n)=>{for(var s=n>1?void 0:n?rn(e,t):e,i=r.length-1,o;i>=0;i--)(o=r[i])&&(s=(n?o(e,t,s):o(s))||s);return n&&s&&tn(e,t,s),s};let me=class extends q{get systems(){return this.getFromModel("systems")}render(){return m`
        <main> 
        <h1>Systems</h1>
        ...
        * {
          margin: 0;
          box-sizing: border-box;
        }`];Dt([_()],me.prototype,"systems",1);me=Dt([g("systems-page")],me);var nn=Object.defineProperty,sn=Object.getOwnPropertyDescriptor,Lt=(r,e,t,n)=>{for(var s=n>1?void 0:n?sn(e,t):e,i=r.length-1,o;i>=0;i--)(o=r[i])&&(s=(n?o(e,t,s):o(s))||s);return n&&s&&nn(e,t,s),s};let ge=class extends q{get pilot(){return this.getFromModel("pilot")}render(){return m`
        <main> 
        <h1>Pilot</h1>
        ...
        * {
          margin: 0;
          box-sizing: border-box;
        }`];Nt([_()],_e.prototype,"factions",1);_e=Nt([g("factions-page")],_e);var ln=Object.defineProperty,cn=Object.getOwnPropertyDescriptor,Ht=(r,e,t,n)=>{for(var s=n>1?void 0:n?cn(e,t):e,i=r.length-1,o;i>=0;i--)(o=r[i])&&(s=(n?o(e,t,s):o(s))||s);return n&&s&&ln(e,t,s),s};let ve=class extends q{get roles(){return this.getFromModel("roles")}render(){return m`
        <main> 
        <h1>Roles</h1>
